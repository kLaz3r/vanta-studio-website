  ...
  return (
    <div className="pt-20">
      <section className="relative mx-auto max-w-4xl overflow-hidden px-6 py-24">
        <div className="orb-purple -left-32 -top-32 h-80 w-80" />
        <div className="orb-cyan -bottom-32 -right-32 h-64 w-64" />
        <FadeInView direction="up">
          <div className="relative">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-vanta-light sm:text-5xl">
              Graphic Design pentru <span className="gradient-text">Digital și Print</span>
            </h1>
